...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 03 2024 г., 22:32
...
CREATE TABLE `contacts` (
  ...
  `photo_before` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `contacts` (`id`, `id_user`, `name`, `email`, `category_id`, `subject`, `message`, `status_id`, `rejection_reason`, `created_at`, `updated_at`, `photo_before`, `photo_after`) VALUES
...
(15, 2, 'Пользователь', 'user@mail.ru', 2, 'Проблемы с тротуарами на улице Ленина', 'Тротуар на улице Ленина в районе дома №12 сильно разрушен, плитка взорвана, местами образуются ямы, что создает опасность для пешеходов. Просим провести ремонт тротуара', 2, NULL, '2024-12-02 19:49:01', '2024-12-03 14:58:33', 'photos/01z4GilA0U7M3LwP2gazeHLl6p7LElwoDR5OUotP.png', NULL),
(16, 2, 'Пользователь', 'user@mail.ru', 1, 'Проблемы с водоотведением на улице Горького', 'Во время дождей на улице Горького происходит затопление дорожного полотна, так как система водоотведения не справляется с нагрузкой. Просим провести работы по улучшению дренажа.', 3, 'Заявка отклонена по причине отсутствия финансовых средств на проведение работ по улучшению дренажа в текущем году.\r\n\r\n\r\n\r\n\r\n\r\n\r\n', '2024-12-02 19:50:40', '2024-12-03 14:47:53', 'photos/k8EZnJFjSOQ5m6SqJHGgFzeoBBaK87YFpSDrb0ZL.jpg', NULL),
