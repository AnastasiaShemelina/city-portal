...
<body class="bg-dark text-white">
    <div class="relative sm:flex sm:justify-between sm:items-center p-6 text-right bg-dark text-white shadow-lg"
        style="border-bottom: 1px solid #444;">
        <!-- Первый блок: Логотип и "Городской портал" -->
            ...
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="font-semibold text-white hover:text-gray-300 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Личный
                        кабинет</a>
                @else
                    <a href="{{ route('login') }}"
                        class="font-semibold text-white hover:text-gray-300 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 mr-4">Войти</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="font-semibold text-white hover:text-gray-300 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Зарегистрироваться</a>
                    @endif
                @endauth
            @endif
        </div>
